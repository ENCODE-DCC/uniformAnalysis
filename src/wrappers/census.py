...
def version(step, logOut=True):
    ...
    '''
    pyVersion = step.ana.getCmdOut(step.ana.getToolPath('python') + " -V 2>&1 | awk '{print $2}'", \
    ...
    version = step.ana.getCmdOut(step.ana.getToolPath('python') + ' ' + \
                                 step.ana.getPath('censusPath',alt='toolPath') + \
